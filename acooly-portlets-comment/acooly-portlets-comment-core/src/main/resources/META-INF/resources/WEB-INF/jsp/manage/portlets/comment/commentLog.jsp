    ...
    <form id="manage_commentLog_searchform" onsubmit="return false">
      <table class="tableForm" width="100%">
        <tr>
          <td align="left">
          	<div>
                评论ID: <input type="text" class="text" size="15" name="search_EQ_commentId"/>
                操作人标志: <input type="text" class="text" size="15" name="search_LIKE_userNo"/>
                ...
                操作IP: <input type="text" type="text" class="text" size="15" name="search_LIKE_actionIp"/>
                操作时间: <input size="10" type="text" class="text" id="search_GTE_createTime" name="search_GTE_createTime" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" />
