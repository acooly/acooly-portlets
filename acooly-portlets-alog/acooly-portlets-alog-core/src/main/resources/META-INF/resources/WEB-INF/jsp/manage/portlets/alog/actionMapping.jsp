...
<div class="easyui-layout" data-options="fit : true,border : false">
        ...
        <form id="manage_actionMapping_searchform" onsubmit="return false">
            <table class="tableForm" width="100%">
                <tr>
                    <td align="left">
                        <div>
                            行为类型: <select style="width:80px;height:27px;" name="search_EQ_mappingType" editable="false" panelHeight="auto" class="easyui-combobox">
                            <option value="">所有</option>
                            <c:forEach var="e" items="${allMappingTypes}">
                                <option value="${e.key}" ${param.search_EQ_mappingType == e.key?'selected':''}>${e.value}</option>
                            </c:forEach></select>
                            行为Key: <input type="text" class="text" size="15" name="search_LIKE_actionKey"/>
                            行为分组: <input type="text" class="text" size="15" name="search_LIKE_actionGroup"/>
                            <a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:false"
                               onclick="$.acooly.framework.search('manage_actionMapping_searchform','manage_actionMapping_datagrid');"><i class="fa fa-search fa-lg fa-fw fa-col"></i>查询</a>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_actionMapping_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/portlets/alog/actionMapping/listJson.html"
        ...
        <div id="manage_actionMapping_action" style="display: none;">
            <a onclick="$.acooly.framework.edit({url:'/manage/portlets/alog/actionMapping/edit.html',id:'{0}',entity:'actionMapping',width:500,height:400});" href="#" title="编辑"><i
                    class="fa fa-pencil fa-lg fa-fw fa-col"></i></a>
            <a onclick="$.acooly.framework.show('/manage/portlets/alog/actionMapping/show.html?id={0}',500,400);" href="#" title="查看"><i class="fa fa-file-o fa-lg fa-fw fa-col"></i></a>
        ...
        <div id="manage_actionMapping_toolbar">
            <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.create({url:'/manage/portlets/alog/actionMapping/create.html',entity:'actionMapping',width:500,height:400})"><i
