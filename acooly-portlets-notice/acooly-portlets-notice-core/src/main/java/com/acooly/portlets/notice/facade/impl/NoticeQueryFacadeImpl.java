...
/**
 * @author liubin@prosysoft.com on 2017/12/17.
 */
@Service(version = "1.0")
public class NoticeQueryFacadeImpl implements NoticeQueryFacade {
    ...
    public PageResult<PageableNoticeInfo> pageList(PageOrder order) {
        PageResult<PageableNoticeInfo> pageResult = new PageResult<PageableNoticeInfo>();
    ...
    public SingleResult<Long> countUnreadNotice(SingleOrder<CountNoticeDto> order) {
        ...
        SingleResult<Long> result = new SingleResult<Long>();
        result.setDto(count);
        return result;
    }
