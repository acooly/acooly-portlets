...
<script type="text/javascript">
    ...
    function manage_feedback_searchform_busiCode_onLoadSuccess(row, data) {
        $(".tree-icon,.tree-file").removeClass("tree-file");
        $(".tree-icon,.tree-folder").removeClass("tree-folder-open tree-folder");
        console.info("row,data", row, data);
        for (var i = 0; i < data.length; i++) {
            if (data[i].id) {
                var node = $("#manage_feedback_searchform_busiCode").combotree('tree').tree("find", data[i].id);
                $("#manage_feedback_searchform_busiCode").combotree('tree').tree('expandAll', node.target);//展开所有节点
            }
        }
    }
</script>
<div class="easyui-layout" data-options="fit : true,border : false">
                ...
                <tr>
                    <td align="left">
                        <div>
                            ...
                            业务分类：<select id="manage_feedback_searchform_busiCode" class="easyui-combotree" name="busiTypeId" style="width:100px;"
                                         data-options="url:'/manage/module/treeType/treeType/loadTree.html?theme=feedback',
                                    ...
                                    onLoadSuccess:manage_feedback_searchform_busiCode_onLoadSuccess">
                            <option>所有</option>
                        </select>
                            用户: <input type="text" class="text" size="10" name="search_LIKE_userKey"/>
                            ...
                            <a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:false"
                               onclick="$.acooly.framework.search('manage_feedback_searchform','manage_feedback_datagrid');"><i class="fa fa-search fa-lg fa-fw fa-col"></i>查询</a>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_feedback_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/portlets/feedback/feedback/listJson.html" toolbar="#manage_feedback_toolbar"
        ...
        <div id="manage_feedback_action" style="display: none;">
            <a onclick="$.acooly.framework.edit({url:'/manage/portlets/feedback/feedback/edit.html',id:'{0}',entity:'feedback',width:600,height:500,title:'处理'});" href="#" title="处理"><i
            ...
            <a onclick="$.acooly.framework.remove('/manage/portlets/feedback/feedback/deleteJson.html','{0}','manage_feedback_datagrid');" href="#" title="删除"><i
        ...
        <div id="manage_feedback_toolbar">
            ...
            <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.removes('/manage/portlets/feedback/feedback/deleteJson.html','manage_feedback_datagrid')"><i
            ...
            <div id="manage_feedback_exports_menu" style="width:150px;">
                <div onclick="$.acooly.framework.exports('/manage/portlets/feedback/feedback/exportXls.html','manage_feedback_searchform','客户反馈')"><i class="fa fa-file-excel-o fa-lg fa-fw fa-col"></i>Excel
                </div>
                <div onclick="$.acooly.framework.exports('/manage/portlets/feedback/feedback/exportCsv.html','manage_feedback_searchform','客户反馈')"><i class="fa fa-file-text-o fa-lg fa-fw fa-col"></i>CSV
                </div>
            </div>
        </div>
    </div>
