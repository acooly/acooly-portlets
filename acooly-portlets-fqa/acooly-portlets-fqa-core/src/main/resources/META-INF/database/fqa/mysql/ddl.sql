CREATE TABLE `p_fqa` (
  ...
  `type_code` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '问题分类编码(使用acooly-component-treetype组件，scheme: acooly-portlets-fqa)',
  `type_name` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '问题分类名称(冗余)',
